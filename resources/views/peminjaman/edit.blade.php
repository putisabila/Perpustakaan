        ...
        <form action="{{route('peminjaman.update', $peminjaman->id)}}" method="post">
            ...
            <div class="card-body">
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <input type="integer" name="userID" class="form-control" id="userID" value="{{$peminjaman->userID}}" required>
                      </div>
                    </div>
                    <br>
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <input type="integer" name="bukuID" class="form-control" id="bukuID" value="{{$peminjaman->bukuID}}" required>
                      </div>
                    </div>
                    <br>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="date" name="tanggal_peminjaman" class="form-control" id="tanggal_peminjaman" value="{{$peminjaman->tanggal_peminjaman}}" required>
                        </div>
                      </div>
                      <br>
                    <br>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="date" name="tanggal_pengembalian" class="form-control" id="tanggal_pengembalian" value="{{$peminjaman->tanggal_pengembalian}}" required>
                        </div>
                      </div>
                      <br>
                    <div class="row mb-3">
